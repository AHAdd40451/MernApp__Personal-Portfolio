          ...
          <article className='service'>
            ...
            <ul className='service__list'>
              <li><BiCheck className='service__list-icon' />
                <p>HTML/CSS/js/bootstrap custom website.
                </p></li>
              <li><BiCheck className='service__list-icon' />
                <p>PSD to bootstrap template.</p></li>
              <li><BiCheck className='service__list-icon' />
                <p>Get your advanced portfolio website</p>
              </li>
              <li><BiCheck className='service__list-icon' />
                <p> HTML CSS bootstrap bug fixing.

                </p>
              </li>

              <li><BiCheck className='service__list-icon' />
                <p> Template customization.
              ...
              </li>     <li><BiCheck className='service__list-icon' />
                <p>
                  Mobile-Friendly websites and landing pages   100%
